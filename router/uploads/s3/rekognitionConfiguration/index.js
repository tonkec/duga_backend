...
const EXPLICIT_BLOCK_THRESHOLD = Number(
  process.env.EXPLICIT_BLOCK_THRESHOLD ?? 0.9
);
const SUGGESTIVE_BLOCK_THRESHOLD = Number(
  process.env.SUGGESTIVE_BLOCK_THRESHOLD ?? 0.75
);
